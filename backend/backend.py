...
# @app.post("/deleteConference")
# def deleteConference(body: Dict[Any, Any]):
#     telegramId = body["telegramId"]
#     conferenceId = body["conferenceId"]

#     try:
#         sheetsController.delete_conference(str(telegramId), str(conferenceId))
#     except Exception as e:
#         return JSONResponse(content={"message": str(e)}, status_code=500)
...
# @app.post("/addOrgStatus")
# def addOrgStatus(body: Dict[Any, Any]):
#     try:
#         sheetsController.add_org_state(body["telegramId"])
#     except Exception as e:
#         return JSONResponse(content={"message": str(e)}, status_code=500)
